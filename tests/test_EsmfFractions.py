...
class Test(unittest.TestCase):
    ...
    def test1_2d_esmf_native_tripolar_fraction(self):
        ...
        srcGrid = ESMF.Grid(srcMaxIndex, num_peri_dims=0, coord_sys = ESMF.CoordSys.SPH_DEG, staggerloc=[ESMF.StaggerLoc.CENTER])
        ...
        dstGrid = ESMF.Grid(dstMaxIndex, num_peri_dims=0, coord_sys = ESMF.CoordSys.SPH_DEG, staggerloc=[ESMF.StaggerLoc.CENTER])
