...
class TestExtendedWraparound(basetest.CDMSBaseTest):
    ...
    def testWraparound(self):
        ...
        self.assertWrapsCorrectly(rlat, (90.0001,90.0001,'ccn'),(0,None,-1))
        self.assertWrapsCorrectly(rlat, (-90.0001,-90.0001,'ccn'),(15,14,-1))

        self.assertWrapsCorrectly(rlat_nounits,(-90,90,'cc'),(15,None,-1))
        ...
        self.assertWrapsCorrectly(rlat_nounits, (90.0001,90.0001,'ccn'),(0,None,-1))
        self.assertWrapsCorrectly(rlat_nounits, (-90.0001,-90.0001,'ccn'),(15,14,-1))
        ...
        self.assertWrapsCorrectly(time, ('1999-12-1','1999-12-10','cob'),(0,1))
