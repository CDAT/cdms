    ...
    def __init__(self, host, port=80, timeout=15, limit=None, offset=0,
        ...
        if fileids is not None:
            ...
            self.fileids = genutil.StringConstructor(
                "%s.%%(filename)" % self.datasetids.template)
        else:
            self.fileids = None
...
class esgfFiles(object):
    def __init__(self, files, parent, mapping=None,
                 datasetids=None, fileids=None):
        self._files = files
