...
class createGridAndField:
  def __init__(self, maxIndex):
      ...
      self.grid = ESMF.Grid(maxIndex, num_peri_dims=0, coord_sys=COORDSYS, staggerloc=[CENTER])
      self.field= ESMF.Field(self.grid, name='srcField1',staggerloc=CENTER, typekind = R4)
