...
#        srcMask = ESMP.ESMP_GridGetItem(srcGrid, item=ESMP.ESMP_GRIDITEM_MASK)
        ...
        # create field
        srcFld = ESMF.Field(srcGrid, name='srcFld', typekind=ESMF.TypeKind.R4, staggerloc=ESMF.StaggerLoc.CENTER)
        srcFldPtr = srcFld.data

        dstFld = ESMF.Field(dstGrid, name='dstFld', typekind=ESMF.TypeKind.R4, staggerloc=ESMF.StaggerLoc.CENTER)
